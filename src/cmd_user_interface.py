...
class CmdUserInterface:
    ...
    def __init__(self):
        self.menu_options = ['Get ITJobsWatch top 30 - Skills/Roles (data)']
    ...
    def manage_get_ITJW_top_30_menu(self):
        ...
        if option_selected.lower() == 'exit':
            ...
            self.manage_get_ITJW_top_30_menu()
        elif int(option_selected) == 1: # THIS
            ...
            Top30CSVGenerator().generate_top_30_csv(top_30.get_top_30_table_elements_into_array(), os.path.expanduser('~/Downloads/'), 'ItJobsWatchTop30.data', top_30.get_table_headers_array())
